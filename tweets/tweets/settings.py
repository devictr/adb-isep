...
SECRET_KEY = '33a!plaq_r1+pv)ve2b7=^8vi@)9@%lerfz0fmfjl5!@x&t!os'
...
STATIC_ROOT = os.path.join(PROJECT_HOME, 'collected_static/')
...
MONGO_COLLECTION = _MONGO_CLIENT.tweets
MONGO_DATABASE = MONGO_COLLECTION.tweets
